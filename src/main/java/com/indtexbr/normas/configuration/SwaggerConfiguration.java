...
public class SwaggerConfiguration implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(new ApiInfo("Gestão de Normas", "Microsservi\u00e7o respons\u00e1vel pela orquestra\u00e7\u00e3o de Normas", "1.0", "urn:tos",
                        new Contact("Letícia Fideles","","lfideles@indtexbr.com.br"), "Apache 2.0", "http://www.apache.org/licenses/LICENSE-2.0", new ArrayList<VendorExtension>()))
